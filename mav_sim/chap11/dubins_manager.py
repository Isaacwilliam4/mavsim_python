...
def construct_dubins_line(desired_airspeed: float, dubins_path: DubinsParameters) \
    -> tuple[MsgPath, HalfSpaceParams]:
...
def construct_dubins_circle_end(desired_airspeed: float, dubins_path: DubinsParameters) \
    -> tuple[MsgPath, HalfSpaceParams]:
